...
public class Player : MonoBehaviour {
	...
	public ParticleSystem teleportLeave;
	public ParticleSystem teleportArrive;
    ...
    {
		teleportLeave.transform.position = transform.position;
		teleportArrive.transform.position = newPosition;
